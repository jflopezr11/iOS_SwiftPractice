...
class ViewController: UIViewController {
    ...
    @objc func updateUI() {
        ...
        let answerChoices = quizBrain.updateButtonAnswers()
        choiceButtonOne.setTitle(answerChoices[0], for: .normal)
        choiceButtonTwo.setTitle(answerChoices[1], for: .normal)
        choiceButtonThree.setTitle(answerChoices[2], for: .normal)
    }
